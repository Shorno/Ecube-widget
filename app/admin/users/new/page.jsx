        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <Label className="text-sm font-medium text-gray-400">
              Password{" "}
              <span className="font-normal text-gray-600">(min 8 chars)</span>
            </Label>
          ...
          <div className="space-y-1.5">
              ...
              <PopoverTrigger className="inline-flex h-10 w-full items-center gap-2 rounded border border-gray-700 bg-gray-800 px-3 text-sm hover:bg-gray-700 focus:outline-none">
                ...
                {form.subscriptionExpiry ? (
                  <span className="text-white">
                    {formatDisplay(form.subscriptionExpiry)}
                  </span>
                ) : (
              ...
              >
                <Calendar
                  ...
                  onSelect={(date) => {
                    setForm((p) => ({
                      ...p,
                      subscriptionExpiry: objToDateStr(date),
                    }));
                    setCalOpen(false);
                  }}
            ...
            {form.subscriptionExpiry && (
              <button
                type="button"
                onClick={() =>
                  setForm((p) => ({ ...p, subscriptionExpiry: "" }))
                }
          ...
          <div className="rounded border border-gray-800 bg-gray-950/60 px-4 py-3">
            <p className="text-sm text-gray-500">
              A unique ID is generated as{" "}
              <span className="font-mono text-gray-400">
                effinity-{"{16chars}"}
              </span>
              . Tournament IDs, designs and color themes are assigned after
              creation.
            </p>
          </div>
