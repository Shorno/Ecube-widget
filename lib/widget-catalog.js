...
export const IN_GAME_WIDGETS = [
  ...
  { id: "eliminations",   label: "Eliminations",    slug: "eliminations",   section: "in-game" },
  { id: "top-four",       label: "Top Four",        slug: "top-four",       section: "in-game" },
  { id: "first-blood",    label: "First Blood",     slug: "first-blood",    section: "in-game" },
  { id: "live-ranking",   label: "Live Ranking",    slug: "live-ranking",   section: "in-game" },
  { id: "overall-ranking",label: "Overall Ranking", slug: "overall-ranking",section: "in-game" },
  { id: "map",            label: "Map",             path: "http://localhost:10087/map-overlay/map",         section: "in-game" },
  { id: "map-control",    label: "Map Control",     path: "http://localhost:10087/map-overlay/map/control", section: "in-game" },
];
...
export function getWidgetPath(widget, tournamentId) {
  ...
  return `/${tid}/${section}/${widget.slug}`;
}

export function getWidgetPlaceholder(widget) {
  if (widget.path) return widget.path;
  const section = widget.section === "in-game" ? "in-game" : "after-match";
  return `/{tournamentId}/${section}/${widget.slug}`;
}
