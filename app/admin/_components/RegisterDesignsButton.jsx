  ...
  return (
    <Button
      ...
      className={[
        ...
        isOk    ? "border-emerald-700 bg-emerald-950/30 text-emerald-400 hover:bg-emerald-950/50 hover:text-emerald-300"
        : isError ? "border-red-700 bg-red-950/30 text-red-400 hover:bg-red-950/50 hover:text-red-300"
        : "border-gray-700 text-gray-400 hover:border-gray-500 hover:bg-gray-800 hover:text-white",
      ].join(" ")}
    >
      {isLoading ? "Registering…"
        : isOk    ? `✓ ${count} design${count !== "1" ? "s" : ""} registered`
