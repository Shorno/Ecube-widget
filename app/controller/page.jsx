        ...
        <div className="border-b border-red-700 bg-red-950 px-5 py-2">
          <div className="flex items-start justify-between gap-4">
            ...
            <button
              ...
              className="my-auto shrink-0 cursor-pointer bg-red-900 p-4 text-xs font-bold text-red-100 transition-colors hover:text-red-300"
            >
              Dismiss
            </button>
          </div>
      ...
      <div className="flex items-center justify-between gap-4 border-b border-gray-800 bg-gray-950 px-5 py-2">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <Link
            href="/display"
            target="_blank"
            className="border border-gray-600 px-3 py-1 text-xs font-bold tracking-wider text-gray-400 uppercase transition-colors hover:border-blue-500 hover:text-blue-400"
          >
            Open ↗
          </Link>
          <Link
            href="/widgets"
            className="border border-gray-700 px-3 py-1 text-xs font-bold tracking-wider text-gray-500 uppercase transition-colors hover:border-gray-400 hover:text-gray-300"
          >
            Individual Links
          </Link>
        </div>
      ...
      <main className="space-y-7 p-5">
        ...
        <div>
          <button
            ...
            className={[
              "h-9 cursor-pointer border px-6 text-xs font-bold tracking-widest uppercase transition-colors",
