...
const METHOD_COLORS = {
  ...
  PATCH: "bg-blue-950/60 text-blue-400",
};
    ...
    <div className="rounded border border-gray-800 bg-gray-900/60">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-800 px-5 py-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            onClick={refresh}
            className="rounded border border-gray-700 px-2 py-1.5 text-xs text-gray-400 transition-colors hover:border-gray-500 hover:text-white"
          >
            Refresh
          </button>
        </div>
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-gray-800 text-left text-[11px] font-semibold tracking-wider text-gray-600 uppercase">
