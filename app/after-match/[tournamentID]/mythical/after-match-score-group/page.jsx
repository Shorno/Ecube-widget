      ...
      <div ref={containerRef}>
        <Layout top>
          <div className="anim-title opacity-0">
            <Title side title="Overall Ranking" data={data?.info} />
          </div>
          <div className="wrapper grid h-auto! grid-cols-2 gap-4">
            <div className="mx-auto w-215">
              <div className="anim-header-left opacity-0">
                <Tableheader mythical overall />
              </div>
              <div className="">
                {colOne.map((team, index) => (
                  <TableRow
                    mythical
                    key={team.team_id}
                    team={team}
                    overall
                    isLast={index === colOne.length - 1}
            ...
            <div className="mx-auto w-215">
              ...
              <div className="">
                {colTwo.map((team, index) => (
                  <TableRow
                    mythical
                    key={team.team_id}
                    team={team}
                    overall
                    isLast={index === colTwo.length - 1}
