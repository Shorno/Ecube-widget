...
export const widgetApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getAfterMatchScoreGroup: builder.query({
      query: ({ tournamentID }) => `${tournamentID}/group/team-scoreboard`,
    }),
    ...
    getHeadToHead: builder.query({
      query: ({ tournamentID }) => `${tournamentID}/match/top-teams?limit=2`,
    }),
    getMvpMatch: builder.query({
      query: ({ tournamentID }) => `${tournamentID}/match/mvp`,
    }),
    getMvpGroup: builder.query({
      query: ({ tournamentID }) => `${tournamentID}/group/mvp`,
    }),
  }),
});
