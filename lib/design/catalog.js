...
export const TOKEN_MAP = [
  { path: ["primary",   "DEFAULT"],    css: "--color-primary"         },
  { path: ["primary",   "background"], css: "--color-primary-bg"      },
  { path: ["primary",   "border"],     css: "--color-primary-border"  },
  { path: ["primary",   "dark"],       css: "--color-primary-dark"    },
  { path: ["secondary", "DEFAULT"],    css: "--color-secondary"       },
  { path: ["secondary", "background"], css: "--color-secondary-bg"    },
  { path: ["secondary", "border"],     css: "--color-secondary-border"},
  { path: ["secondary", "dark"],       css: "--color-secondary-dark"  },
  { path: ["status",    "alive"],      css: "--color-status-alive"    },
  { path: ["status",    "knocked"],    css: "--color-status-knocked"  },
  { path: ["status",    "dead"],       css: "--color-status-dead"     },
  { path: ["background"],              css: "--color-bg"              },
  { path: ["text"],                    css: "--color-text"            },
  { path: ["gradient",  "start"],      css: "--color-gradient-start"  },
  { path: ["gradient",  "end"],        css: "--color-gradient-end"    },
];
